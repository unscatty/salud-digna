...
export default function PlatilloPlan(props) {
  return (
    <>
      <div
        className={`platillo card p-2 bg-${
      ...
      >
        ...
        {props.state === 'active' && (
          <span className="position-absolute left-50% translate-[-50%] translate-y-[-50%] text-[8px]  font-semibold inline-block  px-2 uppercase rounded-full text-fifth bg-third uppercase last:mr-0 mr-1 font-bold drop-shadow-md">
            HORA
          </span>
        )}
      </div>
