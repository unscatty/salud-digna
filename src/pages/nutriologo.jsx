  ...
  return (
    <div className="container-nutriologo">
      ...
      <div className="container-nutriologo__content grid gap-10 p-10 grid-rows-[auto_1fr_1fr_1fr] ml-20 h-100vh">
        ...
        <div className="grafica bg-third rounded p-4 text-black font-bold  "><p className='text-xl'>Satisfaccion de clientes</p></div>
        <div className="grafica bg-third rounded p-4 text-black"><p className='text-xl font-bold'>Progreso de clientes</p></div>
        <div className="grafica bg-third rounded p-4 text-black ">Mensajes</div>
      </div>
    </div>
  );
}
