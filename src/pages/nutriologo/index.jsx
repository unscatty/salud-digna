...
import { GraficaFelicidad } from './graficas/GraficaFelicidsd';
import { GraficaProgreso } from './graficas/GraficaProgreso';
            ...
            <div className="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
              ...
              <div className="grid grid-cols-1 gap-4 lg:col-span-2">
                ...
                <section aria-labelledby="quick-links-title">
                  <div className="rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:grid-cols-1 sm:gap-px gap-10">
